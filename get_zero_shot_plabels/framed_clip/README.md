# Zero-shot classification with CLIP on FRAMED.

This directory contains code for generating zero-shot classification pseudo-labels with CLIP model on Flowers102 and Resisc45.
