# Zero-shot classification with GPT / LLama with NLP.

This directory contains code for generating zero-shot classification pseudo-labels with GPT-4o, Llama-3.3-70B model on AG news, Yahoo Answers, and Amazon Review datasets.
...
Please take a look at each script files to check modifiable experiment parameters (e.g. selecting dataset, selecting foundation models, selecting train set or test set, etc.) and change them for your needs.
