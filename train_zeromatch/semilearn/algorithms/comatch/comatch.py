...
class CoMatch(AlgorithmBase):
    ...
    def train_step(self, x_lb, y_lb, yp_lb, x_ulb_w, x_ulb_s_0, x_ulb_s_1, yp_ulb):
        num_lb = y_lb.shape[0] 
        ...
        with self.amp_cm():
            if self.use_cat:
                ...
                p_logits_x_ulb_w, p_logits_x_ulb_s_0, _ = p_logits[num_lb:].chunk(3)
            ...
            total_loss = sup_loss + self.lambda_u * unsup_loss + self.lambda_c * contrast_loss + lmbd * ann_alpha * psup_loss
