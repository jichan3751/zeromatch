...
class VAT(AlgorithmBase):
    ...
    def train_step(self, x_lb, y_lb, yp_lb, x_ulb_w, yp_ulb):
        ...
        with self.amp_cm():
            ...
            # psup loss will be computed without freezing batchnorm
            outs_x_ulb_w2 = self.model(x_ulb_w)
            p_logits_x_ulb_w = outs_x_ulb_w2['p_logits']
            ...
            total_loss = sup_loss + self.lambda_u * unsup_loss * unsup_warmup + self.lambda_ent * loss_entmin + lmbd * ann_alpha * psup_loss
