...
def split_ssl_data(args, data, targets, num_classes,
    ...
    return split_ssl_data2(args, data, targets, num_classes,
                   lb_num_labels, ulb_num_labels,
                   lb_imbalance_ratio, ulb_imbalance_ratio,
                   lb_index, ulb_index, include_lb_to_ulb, load_exist)
...
def split_ssl_data2(args, data, targets, num_classes,
                   lb_num_labels, ulb_num_labels=None,
                   lb_imbalance_ratio=1.0, ulb_imbalance_ratio=1.0,
                   lb_index=None, ulb_index=None, include_lb_to_ulb=True, load_exist=True):
    ...
    return list_indexing_by_list(data, lb_idx), targets[lb_idx], list_indexing_by_list(data, ulb_idx), targets[ulb_idx], lb_idx, ulb_idx
